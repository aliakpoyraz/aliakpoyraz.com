    ...
    return (
        <section className="mt-14 mb-8 pl-4 border-l border-rose-500/30">
            <div className="flex items-center gap-2 mb-3">
                ...
                <h2 className="text-xs font-semibold uppercase tracking-widest text-zinc-500">AI Özet</h2>
            </div>

            <p className="text-zinc-400 leading-relaxed text-sm italic whitespace-pre-line">
                {summary}
            </p>
